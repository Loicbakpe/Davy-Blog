        ...
        <aside class="w-64 bg-gray-900 dark:bg-black text-white flex-shrink-0 flex flex-col transition-all duration-300">
            ...
            <nav class="flex-1 overflow-y-auto pt-4 pb-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.subscribers.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800 hover:text-white transition-colors {{ request()->routeIs('admin.subscribers.*') ? 'bg-gray-800 text-white border-l-4 border-indigo-500' : '' }}">
                            <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            Abonnés
                        </a>
                    </li>
                    <li>
